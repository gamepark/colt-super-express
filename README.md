...
Once you have one Material type and one Location type, you can start to setup a new game in [ColtSuperExpressRules.ts](/rules/src/ColtSuperExpressRules.ts)
